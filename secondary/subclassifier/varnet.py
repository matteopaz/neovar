...
class VARnet(nn.Module):
    def __init__(self, samples, out, wavelet, learnsamples=False, infeatures=3):
        super().__init__()
        ...
        self.cnn1 = nn.Conv1d(infeatures, 16, 13, padding="same")
        self.cnn2 = nn.Conv1d(16, 24, 11, padding="same")
        self.cnn3 = nn.Conv1d(24, 4, 9, padding="same")

        self.cnn4 = nn.Conv1d(8+infeatures, 32, 9, padding="same")
